...
# CSS content with @font-face placeholders
css_content = """/* Load custom fonts (placeholders) */
@font-face {
    font-family: "Kemety";
    src: url("../fonts/Kemety.ttf") format("truetype");
}

@font-face {
    font-family: "Medu Netcher";
    src: url("../fonts/MeduNetcher.ttf") format("truetype");
}

/* Headings: Kemety + Medu Netcher fonts */
h1, h2, h3 {
    font-family:
        "Kemety",
        "Medu Netcher",
...
# Placeholder README for fonts
readme_content = """# Font Placeholders
Add your Kemety and Medu Netcher font files here:
- Kemety.ttf
- MeduNetcher.ttf

You can host these fonts locally or replace the @font-face URLs with CDN links.
"""
...
with open(os.path.join(fonts_dir, "README.txt"), "w", encoding="utf-8") as f:
